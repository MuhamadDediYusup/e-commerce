...
class HomeController extends Controller
{
    ...
    public function profileUpdate(Request $request,$id){
        ...
        if($status){
            request()->session()->flash('success','Berhasil memperbarui profil Anda');
        }
        else{
    ...
    public function userOrderDelete($id)
    {
        ...
        if($order){
           if($order->status=="process" || $order->status=='delivered' || $order->status=='cancel'){
                return redirect()->back()->with('error','Kamu tidak bisa menghapus pesanan ini sekarang');
           }
           else{
                $status=$order->delete();
                if($status){
                    ...
                    request()->session()->flash('error','Pesanan tidak bisa dihapus');
                }
