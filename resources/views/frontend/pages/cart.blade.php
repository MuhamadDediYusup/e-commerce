                    ...
                    <tbody id="cart_item_list">
                        <form action="{{route('cart.update')}}" method="POST">
                            ...
                            <tr>
                                ...
                                <td class="price" data-title="Harga"><span>Rp{{number_format($cart['price'],2)}}</span>
                                </td>
                                ...
                                <td class="action" data-title="Hapus"><a href="{{route('cart-delete',$cart->id)}}"><i
                            ...
                            <tr>
                                <td class="text-center">
                                    Tidak ada keranjang yang tersedia. <a href="{{route('product-grids')}}"
                                        style="color:blue;">Lanjutkan berbelanja</a>
                        ...
                        <div class="col-lg-4 col-md-7 col-12">
                            <div class="right">
                                <ul>
                                    ...
                                    <li class="coupon_price" data-price="{{Session::get('coupon')['value']}}">Anda
                                        Hemat<span>Rp{{number_format(Session::get('coupon')['value'],2)}}</span></li>
                                    @endif
                                    @php
